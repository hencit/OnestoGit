    ...
    Sub view_record()
        Try
            ...
            While myReader.Read
                ...
                pictures = {GetSysInit("lampiran") + lblStandard.Text}
    ...
    Sub getImage(ByVal ext As String)
        Try
            ...
            ElseIf ext = ".xls" Or ext = ".xlsx" Then
                PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + excelicon)
            ElseIf ext = ".pdf" Then
                PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + pdficon)
            ElseIf ext = ".mp4" Or ext = ".wav" Then
                PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + videoicon)
            ElseIf ext = ".doc" Or ext = ".docx" Then
                PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + wordicon)
            ElseIf ext = "" Then
                PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + emptyicon)
            Else
                PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + elseicon)
            End If
            lblImage.Text = GetSysInit("lampiran") + pictures(z)
        ...
        If OFDLampiran.FileName <> "" Then
            Try
                ...
                If flagLampiran = 1 Then
                    ...
                    lblStandard.Text = FileName
                End If

                If flag <> 0 Then
                    Try
                        cmd = New SqlCommand("update mt_tugas set " + link_before + " = '" + FileName + "' where tugas_code = '" + txtKodeTugas.Text + "' ", cn)
