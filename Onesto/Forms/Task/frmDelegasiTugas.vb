...
Public Class frmDelegasiTugas
    ...
    Sub loadImage()
        If returnImage(lblStandard.Text) = "1" Then
            original = Image.FromFile(GetSysInit("lampiran") + lblStandard.Text)
            resized = ResizeImage(original, New Size(pbStandard.Size))
            pbStandard.Image = resized
        Else
            pbStandard.Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblStandard.Text))
        End If
        If returnImage(lblBefore.Text) = "1" Then
            original = Image.FromFile(GetSysInit("lampiran") + lblBefore.Text)
            resized = ResizeImage(original, New Size(pbBefore.Size))
            pbBefore.Image = resized
        Else
            pbBefore.Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblBefore.Text))
        End If
        If returnImage(lblAfter1.Text) = "1" Then
            original = Image.FromFile(GetSysInit("lampiran") + lblAfter1.Text)
            resized = ResizeImage(original, New Size(pbAfter1.Size))
            pbAfter1.Image = resized
        Else
            pbAfter1.Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblAfter1.Text))
        End If
        If returnImage(lblAfter2.Text) = "1" Then
            original = Image.FromFile(GetSysInit("lampiran") + lblAfter2.Text)
            resized = ResizeImage(original, New Size(pbAfter2.Size))
            pbAfter2.Image = resized
        Else
            pbAfter2.Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblAfter2.Text))
        End If
    End Sub
    ...
    Function returnImage(ByVal ext As String) As String
        extension = Path.GetExtension(GetSysInit("lampiran") + ext)
    ...
    Sub clear_obj()
        ...
        lblAfter2.Text = ""
        Try
            PictureBox1.Image = Image.FromFile(GetSysInit("lampiran") + emptyicon)
        Catch ex As Exception
        ...
        If OFDLampiran.FileName <> "" Then
            Try
                ...
                If flagLampiran = 2 Then
                    ...
                    lblBefore.Text = FileName
                ElseIf flagLampiran = 3 Then
                    link_after = "link_after1"
                    lblAfter1.Text = FileName
                Else
                    link_after = "link_after2"
                    lblAfter2.Text = FileName
                End If

                If flag <> 0 Then
                    Try
                        cmd = New SqlCommand("update tr_tugas set " + link_after + " = '" + FileName + "' where tugas_no = '" + txtNoTugas.Text + "' ", cn)
        ...
        With PictureBox1
            ...
            Try
                If returnImage(lblAfter2.Text) = "1" Then
                    ...
                    .Image = resized
                Else
                    .Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblStandard.Text))
                End If
            Catch ex As Exception
                .Image = Nothing
            End Try
        ...
        With PictureBox1
            ...
            Try
                If returnImage(lblAfter2.Text) = "1" Then
                    ...
                    .Image = resized
                Else
                    .Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblBefore.Text))
                End If
            Catch ex As Exception
                .Image = Nothing
            End Try
        ...
        With PictureBox1
            ...
            Try
                If returnImage(lblAfter2.Text) = "1" Then
                    ...
                    .Image = resized
                Else
                    .Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblAfter1.Text))
                End If
            Catch ex As Exception
                .Image = Nothing
            End Try
        ...
        With PictureBox1
            ...
            Try
                If returnImage(lblAfter2.Text) = "1" Then
                    ...
                    .Image = resized
                Else
                    .Image = Image.FromFile(GetSysInit("lampiran") + returnImage(lblAfter2.Text))
                End If
            Catch ex As Exception
                .Image = Nothing
            End Try
